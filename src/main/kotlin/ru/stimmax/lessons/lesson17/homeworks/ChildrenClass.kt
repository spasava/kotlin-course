...
import org.example.ru.stimmax.lessons.lesson17.homeworks.BaseClass

fun changePublicField(value: String) {
    var publicField = value
}

fun changeProtectedFieldFromChild(value: String) {
    var protectedField = value
